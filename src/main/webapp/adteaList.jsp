              ...
              <div class="home-tab">
                ...
                <div class="tab-content tab-content-basic">
                  <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview"> 
    				...
    				<div class="product">
    					<a href="teaDetailPage.do?teaNum=${ teaData.teaNum }" class="img-prod"><img class="img-fluid" src="${ tdata.imageUrl }" alt="Colorlib Template">
    					...
    					<div class="text py-3 pb-4 px-3 text-center">
	    					...
	    					<div class="bottom-area d-flex px-3">
	    						<div class="m-auto d-flex">
	    							...
	    							<a id="${teaData.teaNum}" href="#" class="heart d-flex justify-content-center align-items-center ">
	    								<span><i class="ion-ios-heart"></i></span>
	    							</a>
	    							</c:if>
    							</div>
